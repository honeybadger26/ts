...
- Switch between item types (My work, My teams work, other)
    ...
    - OR instead of Favorites, maybe a 'Most Recent' category. Idk about you guys, but I tend to rotate between about ~5 items at any one time and this wouldn't require user to set favorites.
